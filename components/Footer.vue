          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6">
              <div class="footer-widget footer-widget__about">
                ...
                <p>Solusi Digital Terpercaya untuk Bisnis Anda</p>
              ...
              <div class="footer-widget footer-widget__contact">
                ...
                <ul class="footer-widget__contact-list list-unstyled">
                  <li>
                    ...
                    <a href="tel:777-888-0000">+62 819-3496-6774</a>
                  </li>
                  <li>
                    <i class="fa fa-envelope"></i>
                    <a href="mailto:needhelp@oapee.com">admin@safaqita.com</a>
                  </li>
                  <li>
                    <i class="fa fa-map-marker"></i>
                   Poja, Desa Candi, Kecamatan Dungkek, <br> Kabupaten Sumenep, Jawa Timur 69474
                  </li>
      ...
      <div class="site-footer__bottom">
        <div class="container">
          <div class="inner-container">
            <p>© copyright 2025 by PT Safaqita Digital Solution</p>
